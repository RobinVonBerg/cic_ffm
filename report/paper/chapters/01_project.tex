\chapter{Projektfindung}\label{chp:projektfindung}
    ...
    \framebox[\textwidth]{
        \begin{minipage}{\textwidth-1em}
            ...
            Abbildung\,\ref{fig:dt_2} zeigt die sechs Phasen, die im Prozess durchlaufen werden und visualisiert den iterativen Ansatz, das mehrmalige Durchlaufen in unterschiedlichen Kreisen im Laufe des Prozesses.\\
